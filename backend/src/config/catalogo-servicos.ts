...
export const SERVICOS_CATALOGO: ServicoCatalogoDef[] = [
  ...
  // Mantidos no catálogo estático para fluxos/preços; ficam ocultos na vitrine via ativo=false no banco.
  {
    slug: 'troca-torneira',
  ...
  // Mantido para fluxo/preço; oculto na vitrine via ativo=false no banco.
  {
