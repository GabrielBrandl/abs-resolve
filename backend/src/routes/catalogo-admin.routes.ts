...
router.post('/servicos/:id/imagens', upload.array('imagens', 12), (req, res) => catalogoAdminController.uploadImagens(req, res));
...
router.post('/agenda', (req, res) => catalogoAdminController.criarAgendamento(req, res));
router.patch('/agenda/:id/detalhes', (req, res) => catalogoAdminController.atualizarDetalhesAgendamento(req, res));
