...
router.post('/checkout-convidado', loginLimiter, (req, res) => authController.checkoutConvidado(req, res));
router.post('/esqueci-senha', loginLimiter, (req, res) => authController.esqueciSenha(req, res));
router.post('/redefinir-senha', loginLimiter, (req, res) => authController.redefinirSenha(req, res));
